...
/* Define cdlog_fstat to fstat or fstat64() */
#if defined(__APPLE__) && !defined(MAC_OS_X_VERSION_10_6)
#define cdlog_fstat fstat64
#define cdlog_stat stat64
#else
#define cdlog_fstat fstat
#define cdlog_stat stat
#endif

/* Define cdlog_fsync to fdatasync() in Linux and fsync() for all the rest */
#ifdef __linux__
#define cdlog_fsync fdatasync
#else
#define cdlog_fsync fsync
#endif
